...
//  Bullseye
//
//  Created by Mehmet Deniz Cengiz on 3/24/20.
    ...
    var body: some View {
        Group{
            VStack{
                ...
                Text("This is Bullseye, the game where you can win points and earn by dragging a slider").modifier(AboutBodyStyle())
